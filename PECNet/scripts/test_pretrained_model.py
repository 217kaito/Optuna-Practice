...
def test(test_dataset, model, hyper_params, device, best_of_n=1):
...
def main():
    ...
    hyper_params = fill_default_hyper_params(checkpoint["hyper_params"])
    print(hyper_params)
    ...
    for i in range(num_samples):
        test_loss, final_point_loss_best, final_point_loss_avg = test(test_dataset, model, hyper_params, device, best_of_n=N)
